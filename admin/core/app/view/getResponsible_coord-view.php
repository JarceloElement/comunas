    ...
    foreach ($res as $row) {
        if ($row['f_name'] != "") {
            $array = array(
                ...
                "message"  => "Ya existe un coordinador con el mismo documento de identidad: ".$row['f_name'],
                "error" => "false",
            ...
            $array = array(
                "nombre"  => "El Coordinador no está registrado",
                "error" => "true",
                "message"  => "La cédula del Coordinador no se encuentra vinculada en Gestión Humana.\n Por favor verifica que sea correcta o consulta con la gerencia de Políticas públicas.",
