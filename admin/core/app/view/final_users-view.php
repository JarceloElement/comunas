...
if ((isset($_GET["q"]) && isset($_GET["user_estado"]) && isset($_GET["user_municipio"]) && isset($_GET["user_type"]) && isset($_GET["user_dni"])) && ($_GET["q"] != "" || $_GET["user_estado"] != ""  || $_GET["user_municipio"] != "" || $_GET["user_type"] != "" || $_GET["user_dni"] != "")) {
	...
	if ($user_estado  != "") {
		$estate = EstadoData::getNameById($user_estado);
	}
	if ($user_municipio  != "") {
		$municipality = MunicipioData::getNameById($user_municipio);
	}
								...
								<td style="width:180px;">
									<?php if ($_SESSION["user_type"] != 10) { ?>
										<?php if ($_SESSION["user_type"] == 5 || $_SESSION["user_type"] == 6 || $_SESSION["user_type"] == 7) { ?>
											...
											<a href="./../index.php?view=finaluser_update&id=<?php echo $user["id"]; ?>" class="btn btn-warning btn-sm"><i><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24">
											...
											<?php $URL = "./?action=finaluser&function=delete&id=" . $user["id"]; ?>
