...
$user = CoordinatorsData::getByIdPg($_GET["id"]);
// print_r($user->f_name);
  ...
  async function validarFormulario(event) {
    ...
    try {
      ...
      if (res.ok) {
        ...
        $('#cover-spin').hide(0);
        window.location.href = "./?view=coordinator&swal="+array.alert;
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            <h4 class="title">Actualizar coordinador</h4>
          </div>
          <br>
          <div class="card-body">

            <form id="send_form" class="form-horizontal" role="form" method="post" action="./?action=coordinator&function=update">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="document_number" value="<?php echo $user->document_number; ?>" placeholder="C.I" required minlength="6" maxlength="8" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);if (this.value < 0) this.value = '',alert('El DNI no es válido');"></input>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="tel" class="form-control" name="phone_number" id="phone_number" placeholder="0416-1234567" value="<?php echo $user->phone_number; ?>" list="list-code" required maxlength="12" list="list_code" pattern="[0-9]{4}-[0-9]{7}"></input>
                  </div>
                </div>
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    <label for="info_cod" class=" control-label"><i class="fa fa-gear"></i> Código Infocentro</label>
                    <input type="text" name="info_cod" onkeydown="value = replace_t(value);" value="<?php echo $user->info_cod; ?>" class="form-control" id="info_cod" placeholder="" style='text-transform:uppercase'>
                  </div>
                </div>
