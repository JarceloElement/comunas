<script language="javascript">
	...
	async function validarFormulario(event) {
		...
		let form = $("#update_prod");
		let url = form.attr('action');
		// let url = "./?action=ajax";

		var data = new FormData(event.target);
		data.append("function", "update_prod");
		console.log(data);
...
<div class="panel panel-default">
	...
	<div class="panel-heading">
		<h4 class="title">
			<span class='text_label'> <i class='fa fa-sliders icon_label'></i> <b> Editando el producto: <?php echo "(" . $prod["action_performed"] . "/" . $prod["format_detail"] . ")" ?></b> </span>
		</h4>
	</div>
				...
				<div class="col-md-12">
					<div class="card">
						...
						<div class="card-body">
							...
							<form id="update_prod" role="form" method="post" action="./?action=ajax">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label for="action_performed" class="control-label">Categoría del producto*</label>
										<select name="action_performed" class="form-control" id="action_performed" required>
											<option value="<?php echo $prod["action_performed"] ?>"> <?php echo $prod["action_performed"] ?> </option>
	...
	<script language="javascript">
		$(document).ready(function() {
			...
			$("#action_performed").change(function() {
				$('#format_detail').find('option').remove().end().append('<option value=""></option>').val('0');
				$("#action_performed option:selected").each(function() {
					categoria = $(this).val();
