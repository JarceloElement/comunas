      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form id="send_form" class="form-horizontal" role="form" method="post" action="./?action=coordinator&function=add">
              <br>
              <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="document_number" id="dni" placeholder="C.I" required minlength="6" maxlength="8" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);if (this.value < 0) this.value = '',alert('El DNI no es válido');"></input>
                  </div>
                </div>
    ...
    $(function() {
      $("#dni").change(function() {
        ...
        if (dni != "") {
          ...
          controladorTiempo = setTimeout(codigoAJAX, 600);
        }
      });
    });
