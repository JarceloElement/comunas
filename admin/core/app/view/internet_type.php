...
<!-- <div class="panel panel-default"> -->
	...
	<div class="panel-heading">
		...
		<span class='text_label'> <i class='fa fa-signal icon_label' ></i> <b> Tipo de internet </b> </span>
		</a>
		</h4>
	</div>
				...
				<div class="col-md-12">
					...
					<div class="card">
						...
						<div class="card-content table-responsive">
							...
							$param = InternetTypeData::getBySQL($sql);
							...
							<?php if(count($param)>0){ ?>
								...
								<table class="table table-bordered table-hover">
									...
									foreach($param as $types){
										...
										<a href="./?action=ajax&function=del_internet_type&id=<?php echo $types->id;?>&type=<?php echo $_GET["type"];?>" class="btn btn-danger btn-xs">Eliminar</a>
										</td>
										</tr>
										<?php
