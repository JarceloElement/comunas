...
function alter_db()
{
    ...
    // ExecutorPg::doit('ALTER TABLE IF EXISTS public.products_list ADD COLUMN IF NOT EXISTS video_url VARCHAR(500);');
    ...
    // ExecutorPg::doit('ALTER TABLE IF EXISTS public.organizaciones ADD COLUMN IF NOT EXISTS n_registro VARCHAR(100);');
    // ExecutorPg::doit('ALTER TABLE IF EXISTS public.organizaciones ADD COLUMN IF NOT EXISTS direccion VARCHAR(200);');
