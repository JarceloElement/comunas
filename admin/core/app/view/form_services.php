		...
		<div class="col-md-6">
			...
			<div class="card p-4">
				    ...
				    <div class="form-group">
                        ...
                        <div ><h6 class="title row justify-content-center">Agregar servicio</h6></div>    
                    </div>
					...
					<form name="form" id="form" accept-charset="UTF-8" class="form-horizontal" method="post" action="index.php?action=services_users&function=add&&pag=" role="form">
						...
						<div class="col-md-12">
                            ...
                            <label class="bmd-label-floating">DNI, nombre o correo</label>
							<!-- <input type="text" name="username" class="form-control" id="username" placeholder="Usuario" required> -->
							<input type="text" name="buscar_participante" id="q_participante" value="" class="form-control">
							</div>
						</div>
						...
						<div class="col-md-12">
                            ...
                            <input type="text" name="user_fecha_servicio" required class="form-control" id="user_fecha_servicio" value="<?php echo date("Y/m/d",time());?>" placeholder="" onfocus="(this.type='date')" >
							</div>
						</div>
