                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="activity" class="form-horizontal" role="form" method="post" action="./?action=updateplanning&pag=<?php echo $_GET["pag"] ?>" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="parroquia" id="parroquias" value="<?php echo $info->parroquia; ?>">
                            ...
                            <div class="form-row">
                                ...
                                <!-- <div class="col-md-12">
                                    <div style="display: none" class="form-group" id="contenido">
                                        ...
                                        <textarea class="form-control" name="contenido_des" placeholder="Nombre" id="contenido_des"><?php echo $activity["developed_content"]; ?></textarea>
                                    </div>
                                </div> -->
