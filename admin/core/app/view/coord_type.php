...
$(document).ready(function(){
	...
	$('#add_coord').click( function() { 
		if ($("#coord_name").val() != ""){ // valida la informacion
			$.post("./?action=ajax", {
				function: "add_coord", // funcion que llama
...
<!-- <div class="panel panel-default"> -->
	...
	<div class="panel-heading">
		...
		<span class='text_label'> <i class='fa fa-sliders icon_label' ></i> <b> Coordinaciones </b> </span>
		</a>
		</h4>
	</div>
				...
				<div class="col-md-12">
					...
					<div class="card">
						...
						<div class="card-content table-responsive">
							...
							$total = CoordTypeData::getAll();
							$TotalReg = count($total);
							
							$sql = "select * from coordinations order by id asc LIMIT ".(($compag-1)*$CantidadMostrar)." , ".$CantidadMostrar;
							$param = CoordTypeData::getBySQL($sql);
							...
							<?php if(count($param)>0){ ?>
								...
								<table class="table table-bordered table-hover">
									...
									foreach($param as $types){
										...
										<a href="./?action=ajax&function=del_coord&id=<?php echo $types->id;?>&type=<?php echo $_GET["type"];?>" class="btn btn-danger btn-xs">Eliminar</a>
										</td>
										</tr>
										<?php
