...
<br>
            ...
            <form class="form-horizontal" role="form" method="post" action="./?action=addciudad">

                <div class="col-md-12">
                    <div class="form-group">
                        <label for="ciudad" class="control-label"><i class="fa fa-map"></i> Nombre*</label>
                        <input type="text" name="ciudad" value="" class="form-control" id="ciudad" placeholder="Ciudad" required>
                    </div>
                </div>
