...
class PlanningActivityData
{
	...
	public function update()
	{
		...
		$sql = "UPDATE reports set 
         ...
         organized_by_info='$this->organized_by_info', 
         date_pub='$this->date_pub', 
         date_ini='$this->date_ini', 
         date_end='$this->date_end', 
         hour_activity='$this->hour_activity', 
	...
	public static function getById($id)
	{
		...
		// return Model::one($query[0],new PlanningActivityData());
	...
	public static function getAll()
	{
		...
		$query = Executor::doit($sql);
		return Model::many($query[0], new PlanningActivityData());
	}
