<?php
class CoordTypeData {
	public static $tablename = "coordinations";
	...
	public function add(){
		$sql = "insert into coordinations (name) ";
		$sql .= "value (\"$this->name\")";
	...
	public static function getById($id){
		...
		return Model::one($query[0],new CoordTypeData());
	}
	...
	public static function getAll(){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new CoordTypeData());
