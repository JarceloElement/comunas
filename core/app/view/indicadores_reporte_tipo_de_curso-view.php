...
if (isset($training_types) && $training_types != null) {
    ...
    foreach ($training_types as $row) {
        ...
        array_push($pie_chart_labels, "'" . $row['name_training_type'] . "'");
...
<script>
    $(document).ready(function () {
        ...
        $(function () {
            ...
            $('#datepicker-reports').on("change", function (ev, picker) {
                ...
                $.post({
                    ...
                    url: "index.php?action=ajax&function=reports_by_training_type",
                    dataType: 'json',
                    data: {
        ...
        for (var counter1 = 0; counter1 < <?php echo $training_types->num_rows ?>; counter1++) {
        ...
        $(function () {
            ...
            $('#datepicker').on("change", function (ev, picker) {
                ...
                $.post({
                    url: "index.php?action=ajax&function=reports_by_training_type_in_general",
                    dataType: 'json',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
...
<div class="tab-content" id="justifiedTabContent">
    <div aria-labelledby="estates-tab" class="tab-pane fade show active" id="estates" role="tabpanel">
        <div class="content">
            <div class="container">
                <h4 class="text-center mb-4 mt-2">Tipos de cursos</h4>
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <?php foreach ($training_types as $row) { ?>
                                                    <th scope="col"><?= $row['name_training_type'] ?></th>
                                                <?php } ?>
    ...
    <div aria-labelledby="national-tab" class="tab-pane fade" id="national" role="tabpanel">
        <div class="offset-md-1 col-md-10">
            <div class="card text-center">
                <div class="card-body">
                    <h5 class="card-title">Tipos de cursos en general</h5>
                    <div class="text-center">
                        <div class="col-md-12 ">
                            <div class="form-group">
                                <label for="fecha" class="control-label"><i class="fa fa-calendar"></i> Fecha de la
