...
=======
>>>>>>> b137e164edf9024850ef944e746fe9c0ae830543
...
=======
                toastify("El documento de identidad debe tener al menos 6 números",true,20000,"warning");
>>>>>>> b137e164edf9024850ef944e746fe9c0ae830543
                $("#user_dni").focus();
                $("#user_dni")[0].scrollIntoView();
            }
...
<<<<<<< HEAD
                type: "POST",
                url: "index.php?action=finaluser&function=getrepeated",
                // headers: {
...
<div class="container">
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-md-12">
        ...
        <div class="row justify-content-center"><h4 class="title">Un paso más <?php echo $_SESSION['user_name']; ?></h4></div>    
        ...
        <div class="card p-4">
            <div class="mui-container-fluid">
                ...
                <form id="userdata" class="form-horizontal" accept-charset="UTF-8" method="post" action="index.php?action=finaluser&function=add" role="form">
                    <input type="hidden" class="form-control" type="email" id="user_id" name="user_id" value="<?php echo $_SESSION['user_id']; ?>"></input>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                            <label for="user_nationality" class=" control-label"><i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 4a4 4 0 0 1 4 4a4 4 0 0 1-4 4a4 4 0 0 1-4-4a4 4 0 0 1 4-4m0 10c4.42 0 8 1.79 8 4v2H4v-2c0-2.21 3.58-4 8-4"/></svg></i> Nacionalidad</label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="user_has_document" class=" control-label"><i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 4a4 4 0 0 1 4 4a4 4 0 0 1-4 4a4 4 0 0 1-4-4a4 4 0 0 1 4-4m0 10c4.42 0 8 1.79 8 4v2H4v-2c0-2.21 3.58-4 8-4"/></svg></i> ¿Está cedulado?</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="user_dni" class=" control-label"><i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 4a4 4 0 0 1 4 4a4 4 0 0 1-4 4a4 4 0 0 1-4-4a4 4 0 0 1 4-4m0 10c4.42 0 8 1.79 8 4v2H4v-2c0-2.21 3.58-4 8-4"/></svg></i> N° documento</label>
                                <input type="number" class="form-control" name="user_dni" id="user_dni" minlength="6" maxlength="8" placeholder="N° documento" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required>
                            </div>
                        </div>

                        <div class="col-md-6">
                            <div class="form-group">
                            <label for="user_nombres" class=" control-label"><i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 4a4 4 0 0 1 4 4a4 4 0 0 1-4 4a4 4 0 0 1-4-4a4 4 0 0 1 4-4m0 10c4.42 0 8 1.79 8 4v2H4v-2c0-2.21 3.58-4 8-4"/></svg></i> Nombres</label>
                            <input type="text" class="form-control" name="user_nombres" placeholder="Nombres" required></input>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                            <label for="user_apellidos" class=" control-label"><i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 4a4 4 0 0 1 4 4a4 4 0 0 1-4 4a4 4 0 0 1-4-4a4 4 0 0 1 4-4m0 10c4.42 0 8 1.79 8 4v2H4v-2c0-2.21 3.58-4 8-4"/></svg></i> Apellidos</label>
                            <input type="text" class="form-control" name="user_apellidos" placeholder="Apellidos" required></input>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                            <label for="user_telefono" class=" control-label"><i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 4a4 4 0 0 1 4 4a4 4 0 0 1-4 4a4 4 0 0 1-4-4a4 4 0 0 1 4-4m0 10c4.42 0 8 1.79 8 4v2H4v-2c0-2.21 3.58-4 8-4"/></svg></i> N° teléfono</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                            <label for="user_correo" class=" control-label"><i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 4a4 4 0 0 1 4 4a4 4 0 0 1-4 4a4 4 0 0 1-4-4a4 4 0 0 1 4-4m0 10c4.42 0 8 1.79 8 4v2H4v-2c0-2.21 3.58-4 8-4"/></svg></i> Correo (Obligatorio para No cedulados)</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                            <label for="user_genero" class=" control-label"><i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 4a4 4 0 0 1 4 4a4 4 0 0 1-4 4a4 4 0 0 1-4-4a4 4 0 0 1 4-4m0 10c4.42 0 8 1.79 8 4v2H4v-2c0-2.21 3.58-4 8-4"/></svg></i> Género</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                            <label for="user_f_nacimiento" class=" control-label"><i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M19 19H5V8h14m-3-7v2H8V1H6v2H5c-1.11 0-2 .89-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2h-1V1"/></svg></i> Fecha nacimiento</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="user_comunity_type" class=" control-label"><i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 4a4 4 0 0 1 4 4a4 4 0 0 1-4 4a4 4 0 0 1-4-4a4 4 0 0 1 4-4m0 10c4.42 0 8 1.79 8 4v2H4v-2c0-2.21 3.58-4 8-4"/></svg></i> Comunidad a la que pertenece</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                            <label for="user_etnia" class=" control-label"><i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 4a4 4 0 0 1 4 4a4 4 0 0 1-4 4a4 4 0 0 1-4-4a4 4 0 0 1 4-4m0 10c4.42 0 8 1.79 8 4v2H4v-2c0-2.21 3.58-4 8-4"/></svg></i> Pueblo indígena</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                            <label for="disability_type" class=" control-label"><i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 4a4 4 0 0 1 4 4a4 4 0 0 1-4 4a4 4 0 0 1-4-4a4 4 0 0 1 4-4m0 10c4.42 0 8 1.79 8 4v2H4v-2c0-2.21 3.58-4 8-4"/></svg></i> Posee alguna discapacidad</label>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                            <label for="user_organizacion" class=" control-label"><i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 4a4 4 0 0 1 4 4a4 4 0 0 1-4 4a4 4 0 0 1-4-4a4 4 0 0 1 4-4m0 10c4.42 0 8 1.79 8 4v2H4v-2c0-2.21 3.58-4 8-4"/></svg></i> Nombre de la Organización social</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                            <label for="user_estado" class=" control-label"><i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="m15 19l-6-2.11V5l6 2.11M20.5 3h-.16L15 5.1L9 3L3.36 4.9c-.21.07-.36.25-.36.48V20.5a.5.5 0 0 0 .5.5c.05 0 .11 0 .16-.03L9 18.9l6 2.1l5.64-1.9c.21-.1.36-.25.36-.48V3.5a.5.5 0 0 0-.5-.5"/></svg></i> Estado</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group" id='recargar_munic'>
                                <label for="user_municipio" class=" control-label"><i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="m15 19l-6-2.11V5l6 2.11M20.5 3h-.16L15 5.1L9 3L3.36 4.9c-.21.07-.36.25-.36.48V20.5a.5.5 0 0 0 .5.5c.05 0 .11 0 .16-.03L9 18.9l6 2.1l5.64-1.9c.21-.1.36-.25.36-.48V3.5a.5.5 0 0 0-.5-.5"/></svg></i> Municipio</label>
                                <select name="user_municipio" class="form-control" id="municipios" required>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                            <label for="user_direccion" class=" control-label"><i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 4a4 4 0 0 1 4 4a4 4 0 0 1-4 4a4 4 0 0 1-4-4a4 4 0 0 1 4-4m0 10c4.42 0 8 1.79 8 4v2H4v-2c0-2.21 3.58-4 8-4"/></svg></i> Dirección</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="user_nivel_academ" class=" control-label"><i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 4a4 4 0 0 1 4 4a4 4 0 0 1-4 4a4 4 0 0 1-4-4a4 4 0 0 1 4-4m0 10c4.42 0 8 1.79 8 4v2H4v-2c0-2.21 3.58-4 8-4"/></svg></i> Nivel académico</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                            <label for="user_profesion" class=" control-label"><i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 4a4 4 0 0 1 4 4a4 4 0 0 1-4 4a4 4 0 0 1-4-4a4 4 0 0 1 4-4m0 10c4.42 0 8 1.79 8 4v2H4v-2c0-2.21 3.58-4 8-4"/></svg></i> Profesión</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                            <label for="user_profesion" class=" control-label"><i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 4a4 4 0 0 1 4 4a4 4 0 0 1-4 4a4 4 0 0 1-4-4a4 4 0 0 1 4-4m0 10c4.42 0 8 1.79 8 4v2H4v-2c0-2.21 3.58-4 8-4"/></svg></i> Ocupación</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                            <label for="user_empleado" class=" control-label"><i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 4a4 4 0 0 1 4 4a4 4 0 0 1-4 4a4 4 0 0 1-4-4a4 4 0 0 1 4-4m0 10c4.42 0 8 1.79 8 4v2H4v-2c0-2.21 3.58-4 8-4"/></svg></i> Situación laboral</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                            <label for="user_institucion" class=" control-label"><i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 4a4 4 0 0 1 4 4a4 4 0 0 1-4 4a4 4 0 0 1-4-4a4 4 0 0 1 4-4m0 10c4.42 0 8 1.79 8 4v2H4v-2c0-2.21 3.58-4 8-4"/></svg></i> Lugar dónde trabaja</label>
...
<div class="container">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            ...
            <div class="row justify-content-center"> Por favor registra los datos de perfil, se usarán para tu record académico y gestión de indicadores</div>
            <!-- <div class="row justify-content-center"> <b>Observación:&nbsp;</b>Si habías llenado éste formulario y sigue apareciendo, edita tus datos en (Configuración / Usuario) para que se actualize en tu perfil.</div>   -->
            <br>
...
<<<<<<< HEAD
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="disability_type" class=" control-label"><i class="fa fa-user"></i> Posee alguna discapacidad</label>
                                    <select name="disability_type" class="form-control" id="disability_type" required>
                                        <option value="">-- DISCAPACIDAD --</option>
                                        <?php foreach ($discapacidad as $name): ?>
                                            <option value="<?php echo $name["disability"]; ?>"> <?php echo $name["disability"]; ?></option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="user_profesion" class=" control-label"><i class="fa fa-user"></i> Ocupación</label>
                                    <select name="user_ocupacion" class="form-control" id="user_ocupacion" required>
                                        <option value=""><?php echo '-SELECCIONE-' ?></option>
                                        <option value="<?php echo 'Otra' ?>"><?php echo 'Otra' ?></option>
                                        <option value="<?php echo 'Desempleado' ?>"><?php echo 'Desempleado' ?></option>
    ...
    <script language="javascript">
        ...
        $(document).ready(function() {
            ...
            input_w.addEventListener("countrychange", function() {
                ...
                document.getElementById("red_whatsapp").value = phone_t + input_w.value;
                // console.log(phone_w);
            });
            phone_w = "+" + phoneInput_w.getSelectedCountryData().dialCode;
