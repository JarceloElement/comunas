...
if (isset($product_categories) && $product_categories != null) {
    ...
    foreach ($product_categories as $row) {
        ...
        array_push($pie_chart_labels, "'" . $row['nombre_categoria'] . "'");
...
<script>
    $(document).ready(function () {
        ...
        $(function () {
            $('#datepicker-categories-products').daterangepicker({
                "showDropdowns": true,
                ranges: {
                    'Hoy': [moment(), moment()],
            ...
            $('#datepicker-categories-products').on("change", function (ev, picker) {

                var start_date = ev.target.value.split(" - ")[0].replaceAll("/", "-");
                var end_date = ev.target.value.split(" - ")[1].replaceAll("/", "-");

                document.getElementById("spinner").style.display = "inline-block";
                document.getElementById("table-product-category").style.display = "none";

                $.post({

                    url: "index.php?action=ajax&function=products_by_category",
                    dataType: 'json',
                    data: {
                    ...
                    success: (response, data) => {
                        ...
                        let table = $('#table-product-category').DataTable();
                        table.clear();
                        ...
                        document.getElementById("table-product-category").style.display = "table";
                    }
                });
            });
        });
        ...
        for (var counter1 = 0; counter1 < <?php echo $product_categories->num_rows ?>; counter1++) {
        ...
        $(function () {
            ...
            $('#datepicker').on("change", function (ev, picker) {
                ...
                $.post({
                    url: "index.php?action=ajax&function=products_by_category_in_general",
                    dataType: 'json',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
    ...
    <div aria-labelledby="estates-tab" class="tab-pane fade show active" id="estates" role="tabpanel">
        <div class="content">
            <div class="container">
                ...
                <h4 class="text-center mb-4 mt-2">Categorias de productos</h4>
                <div class="form-group">
                    <label for="fecha" class="control-label"><i class="fa fa-calendar"></i> Fecha de la
                        actividad</label>
                    <input type="text" name="fecha" required class="form-control" id="datepicker-categories-products"
                        placeholder="Fecha">
                </div>
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <?php foreach ($product_categories as $row) { ?>
                                                    <th scope="col"><?= $row['nombre_categoria'] ?></th>
                                                <?php } ?>
    ...
    <div aria-labelledby="national-tab" class="tab-pane fade" id="national" role="tabpanel">
        <div class="offset-md-1 col-md-10">
            <div class="card text-center">
                <div class="card-body">
                    <h5 class="card-title">Categoria de productos en general</h5>
                    <div class="text-center">
                        <div class="col-md-12 ">
                            <div class="form-group">
                                <label for="fecha" class="control-label"><i class="fa fa-calendar"></i> Fecha de la
