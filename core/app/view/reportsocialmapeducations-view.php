	...
	for (i in names) {
		if (i > 1){
			if (dataMap[i] === ""){
				...
				<div class="form-group col-md-12">
					<blockquote class="blockquote mb-0">
						<p style="color:red;"><small class="text-muted">`+names[i]+`</small></p>
						<p>`+dataMap[i]+`</p>
					</blockquote>
				</div>
				`;
						...
						<div class="card-content table-responsive">
							<div class="card-body">
								...
								<form class="form-inline">
									...
									<div class="form-group mx-sm-2 mb-2">
										<a class="btn btn-secondary mb-2" href="assets/pdf/csv.php?param_csv=<?php echo $param_csv.'&param_sql='.$param_sql.'&DB_name='.$DB_name; ?>" name="Descargar"><span class="material-symbols-outlined">download</span> </a>
									</div>
...
<!-- 
	<p><a href="?view=reportsocialmap&pag=1" class="btn btn-secondary btn-sm"> <span class="material-icons-outlined">west</span> </a></p>
	<p><a href="?view=reportsocialmap&pag=1" class="btn btn-secondary btn-sm"> <span class="material-icons-outlined">west</span> </a></p>
	<p><a href="?view=reportsocialmap&pag=1" class="btn btn-secondary btn-sm"> <span class="material-icons-outlined">west</span> </a></p>
	<p><a href="?view=reportsocialmap&pag=1" class="btn btn-secondary btn-sm"> <span class="material-icons-outlined">west</span> </a></p>
	<p><a href="?view=reportsocialmap&pag=1" class="btn btn-secondary btn-sm"> <span class="material-icons-outlined">west</span> </a></p>
