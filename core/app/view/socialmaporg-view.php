	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-12">
				...
				$users = array();
				if ((isset($_GET["q"]) && $_GET["q"] != "") || (isset($_GET["organization_type"]) && $_GET["organization_type"] != "")) {


					if (($_SESSION["user_type"] != 4 && $_SESSION["user_type"] != 5 && $_SESSION["user_type"] != 6 && $_SESSION["user_type"] != 7 && $_SESSION["user_type"] != 10)) {
						$sql = "SELECT * from info_social_map_organizations WHERE o_state='" . $_SESSION["user_region"] . "' and ";
					} else {
						$sql = "SELECT * from info_social_map_organizations WHERE ";
					}


					if ($_GET["q"] != "") {
						$sql .= " (o_state like '$_GET[q]%' or code_info like '$_GET[q]%') ";
					}

					if ($_GET["organization_type"] != "") {
						if ($_GET["q"] != "") {
							$sql .= " and ";
						}
						$sql .= " organization_type='" . $_GET['organization_type'] . "'";
					}
					...
					$url_pag = "<a href=\"?view=reportsocialmap&q=" . $_GET["q"] . "&organization_type=" . $_GET["organization_type"] . "&pag=";
					...
					if (($_SESSION["user_type"] != 4 && $_SESSION["user_type"] != 5 && $_SESSION["user_type"] != 6 && $_SESSION["user_type"] != 7)) {
						$sql = "SELECT * from info_social_map_organizations WHERE o_state='" . $_SESSION["user_region"] . "' order by id desc LIMIT " . (($compag - 1) * $CantidadMostrar) . " , " . $CantidadMostrar;
						$sql_total = "SELECT * from info_social_map_organizations WHERE o_state='" . $_SESSION["user_region"] . "'";
					} else {
						$sql = "SELECT * from info_social_map_organizations order by id desc LIMIT " . (($compag - 1) * $CantidadMostrar) . " , " . $CantidadMostrar;
						$sql_total = "SELECT * from info_social_map_organizations";
					}
					...
					$url_pag_1 = "?view=socialmaporg&pag=";
					$url_pag = " <a href=\"?view=socialmaporg&pag=";

					$param_csv = $sql_total;
					// $param_csv = "info_social_map_organizations";
					$param_sql = "true";
					// echo $param_csv;
				...
				$DB_name = "info_social_map_organizations";
				...
				<div class="card text-center">
					<div class="col-md-12">
						<br>
						<div class="form-group text_label">
							<span class="badge badge-primary" style="height:40px;">Organizaciones en torno al infocentro</span>
						</div>
						<div class="form-group text_label">
							<?php echo "<span class='text_label'> <i class='fa fa-bullhorn icon_label' ></i> <b> Hay " . $TotalReg . " Registros </b>. La cantidad se dividió a " . $TotalRegistro . " páginas para mostrar de " . $CantidadMostrar . " en " . $CantidadMostrar . "</span>" . "<br><br>"; ?>
						</div>
				...
				<?php if ($_SESSION["user_type"] == 2 || $_SESSION["user_type"] == 3 || $_SESSION["user_type"] == 7 || $_SESSION["user_type"] == 6 || $_SESSION["user_type"] == 5 || $_SESSION["user_type"] == 4 || $_SESSION["user_type"] == 8 || $_SESSION["user_type"] == 9) { ?>
					...
					<ul class="list-group">
						<form class="form-inline">
							<input type="hidden" name="view" value="socialmaporg">
								...
								<div class="row">
									...
									<div class="col-sm-4">
										<li class="list-group-item d-flex">
											...
											<div class="col-sm-6">
												<select name="organization_type" class="form-control" style="min-width: 300px;" id="organization_type">
								...
								<?php if (count($users) > 0) { ?>
									...
									<table id="example" class="table table-bordered table-hover" style="max-width:100%;">
										...
										<thead class="thead-light">
											...
											<th class="priority_5">Dirección</th>
										...
										?>
											<tr>
												...
												<td><?php echo $user->o_state; ?></td>
												<td><?php echo $user->code_info; ?></td>
												<td><?php echo $user->organization_type; ?></td>
												<td><?php echo $user->organization_connection_type; ?></td>
												<td class="priority_5"><?php echo $user->organization_name; ?></td>
												<td class="priority_5"><?php echo $user->organization_dni; ?></td>
												<td class="priority_5"><?php echo $user->organization_address; ?></td>
												<td class="priority_5"><?php echo $user->organization_n_population; ?></td>
												<td class="priority_5"><?php echo $user->organization_n_population_female; ?></td>
												<td class="priority_5"><?php echo $user->organization_n_population_male; ?></td>
											</tr>
