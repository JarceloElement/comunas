...
if (Session::getUID() != "") {
	...
	$usuario_final = $con->query("SELECT * from final_users where user_correo = '$user_correo' ");
	$user_email = "";

	foreach ($usuario_final as $name) :
		$user_email = $name["user_correo"];
	endforeach;
	...
	$(document).ready(function() {
		...
		if (!mobile) {
			...
			Swal.fire({
				icon: 'warning',
				title: '¡Hola!',
				text: "Queremos informarte que en estos momentos estamos en proceso de migración de la Infoapp, esto puede durar una semana. \nEstaremos avisando a las regiones por los canales informativos.",
				showConfirmButton: true,
				timer: 50000
			})
		} else {
			alert('¡Hola!Queremos informarte que en estos momentos estamos en proceso de migración de la Infoapp, esto puede durar una semana. \nEstaremos avisando a las regiones por los canales informativos.');
		}
				...
				<div class="card p-4" style="background-color: #ffffffc2;">
					...
					<div class="mui-container-fluid">
						...
						<div class="row justify-content-center">
							...
							<h6 class="title">Para mejorar el servicio, en estos momentos estamos migrando el sistema.</h6>
						</div>
					...
					<li class="row justify-content-center"> <a class="nav-link" href="index.php?view=signup">
