...
if (isset($strategic_actions) && $strategic_actions != null) {
    ...
    foreach ($strategic_actions as $row) {
        ...
        array_push($pie_chart_labels, "'" . $row['name_action'] . "'");
...
<script>
    $(document).ready(function () {
        ...
        $(function () {
            $('#table-report-strategic-action').DataTable({
        ...
        $(function () {
            $('#datepicker-reports-strategic-action').daterangepicker({
                "showDropdowns": true,
                ranges: {
                    'Hoy': [moment(), moment()],
            ...
            $('#datepicker-reports-strategic-action').on("change", function (ev, picker) {

                var start_date = ev.target.value.split(" - ")[0].replaceAll("/", "-");
                var end_date = ev.target.value.split(" - ")[1].replaceAll("/", "-");

                document.getElementById("spinner").style.display = "inline-block";
                document.getElementById("table-report-strategic-action").style.display = "none";

                $.post({

                    url: "index.php?action=ajax&function=reports_by_strategic_action",
                    dataType: 'json',
                    data: {
                    ...
                    success: (response, data) => {
                        ...
                        let table = $('#table-report-strategic-action').DataTable();
                        table.clear();
                        ...
                        document.getElementById("table-report-strategic-action").style.display = "table";
                    }
                });
            });
        });
        ...
        var strategic_action_colors = [];
        for (var counter1 = 0; counter1 < <?php echo $strategic_actions->num_rows ?>; counter1++) {
            strategic_action_colors.push(ColorCode());
        }
        ...
        let myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: strategic_action_colors,
                    datalabels: {
                        color: 'white',
                        font: {
                        weight: 'bold',
        ...
        $(function () {
            ...
            $('#datepicker').on("change", function (ev, picker) {
                ...
                $.post({
                    url: "index.php?action=ajax&function=reports_by_strategic_action_in_general",
                    dataType: 'json',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
    ...
    <div aria-labelledby="estates-tab" class="tab-pane fade show active" id="estates" role="tabpanel">
        <div class="content">
            <div class="container">
                ...
                <h4 class="text-center mb-4 mt-2">Estrategias de accion</h4>
                <div class="form-group">
                    <label for="fecha" class="control-label"><i class="fa fa-calendar"></i> Fecha de la
                        actividad</label>
                    <input type="text" name="fecha" required class="form-control" id="datepicker-reports-strategic-action"
                        placeholder="Fecha">
                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <table class="table" id="table-report-strategic-action">

                                        <thead>
                                            <tr>
                                                <th scope="col">Estado</th>
                                                <?php foreach ($strategic_actions as $row) { ?>
                                                    <th scope="col"><?= $row['name_action'] ?></th>
                                                <?php } ?>
    ...
    <div aria-labelledby="national-tab" class="tab-pane fade" id="national" role="tabpanel">
        <div class="offset-md-1 col-md-10">
            <div class="card text-center">
                <div class="card-body">
                    <h5 class="card-title">Estrategias de accion en general</h5>
                    <div class="text-center">
                        <div class="col-md-12 ">
                            <div class="form-group">
                                <label for="fecha" class="control-label"><i class="fa fa-calendar"></i> Fecha de la
