    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row justify-content-center container">
                ...
                <div class="col-md-4">
                    <div class="row justify-content-center container">
                        <form action="index.php?view=import_xlsx_encuesta" method="POST" enctype="multipart/form-data" />
        ...
        <div class="col-md-12">
            <div class="card p-2">
                <div class="mui-container-fluid">
                    ...
                    <form id="add_capabilities" accept-charset="UTF-8" class="form-horizontal" method="post" action="index.php?action=capabilities&function=add" role="form">
                        ...
                        <input type="hidden" name="user_municipality" id="user_municipality" value="">
                        <input type="hidden" name="user_parish" id="user_parish" value="">
                        <input type="hidden" name="user_zone_type" id="user_zone_type" value="">
                                ...
                                <div class="card text border-primary mb-3">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group floating-label floating-label-lg form-ripple">
                                            ...
                                            <input required type="text" value="" name="code_info" aria-describedby="exampleFloatingLabel6Help" data="field" class="form-control" id="code_info" placeholder="Código infocentro">
                                        ...
                                        <div class="form-group floating-label floating-label form-ripple">
                                            <input required type="text" value="" name="info_name" id="info_name" placeholder="Nombre del infocentro" aria-describedby="exampleFloatingLabel6Help" data="field" class="form-control">
                            ...
                            <div class="col">
                                <div class="card text border-primary mb-3">
                                    <div class="card-body">
                                        ...
                                        <!-- <span class="material-icons text-primary mt-2 mr-4" style="font-size: 32px;">palette</span> -->
                                        <div class="form-group floating-label floating-label-lg form-ripple">
                                            <input required type="text" value="" name="user_dni" aria-describedby="exampleFloatingLabel6Help" data="field" class="form-control" id="user_dni" minlength="6" maxlength="8" placeholder="20123456" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                        ...
                                        <div class="form-group floating-label floating-label form-ripple">
                                            <input required type="text" value="" name="user_name" id="user_name" placeholder="Nombres" aria-describedby="exampleFloatingLabel6Help" data="field" class="form-control">
                                        ...
                                        <div class="form-group floating-label floating-label form-ripple">
                                            <input required type="text" value="" name="user_lastname" id="user_lastname" placeholder="Apellidos" aria-describedby="exampleFloatingLabel6Help" data="field" class="form-control">
                                        ...
                                        <div class="form-group floating-label floating-label form-ripple">
                                            <input required type="email" value="" name="user_email" id="user_email" placeholder="micorreo@email.com" aria-describedby="exampleFloatingLabel6Help" data="field" class="form-control">
                                        ...
                                        <div class="form-group floating-label floating-label form-ripple">
                                            <input type="tel" value="" name="user_phone" id="user_phone" placeholder="04xx1234567" aria-describedby="exampleFloatingLabel6Help" data="field" class="form-control" maxlength="12" pattern="[0-9]{4}-[0-9]{7}">
                                ...
                                <div class="card text border-primary mb-3">
                                    <div class="card-body">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_blender_user_skills-1" name="user_blender_user_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_blender_user_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_blender_user_skills-2" name="user_blender_user_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_python_user_skills-1" name="user_python_user_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_python_user_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_python_user_skills-2" name="user_python_user_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_stop_motion_skills-1" name="user_stop_motion_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_stop_motion_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_stop_motion_skills-2" name="user_stop_motion_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_web_design_skills-1" name="user_web_design_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_web_design_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_web_design_skills-2" name="user_web_design_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_wordpress_skills-1" name="user_wordpress_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_wordpress_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_wordpress_skills-2" name="user_wordpress_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_html_skills-1" name="user_html_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_html_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_html_skills-2" name="user_html_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_PHP_skills-1" name="user_PHP_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_PHP_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_PHP_skills-2" name="user_PHP_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_blog_design_skills-1" name="user_blog_design_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_blog_design_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_blog_design_skills-2" name="user_blog_design_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_digital_magazine_skills-1" name="user_digital_magazine_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_digital_magazine_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_digital_magazine_skills-2" name="user_digital_magazine_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_digital_economy_skills-1" name="user_digital_economy_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_digital_economy_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_digital_economy_skills-2" name="user_digital_economy_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_crypto_assets_skills-1" name="user_crypto_assets_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_crypto_assets_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_crypto_assets_skills-2" name="user_crypto_assets_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_e_bank_patria_skills-1" name="user_e_bank_patria_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_e_bank_patria_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_e_bank_patria_skills-2" name="user_e_bank_patria_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_e_commerce_skills-1" name="user_e_commerce_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_e_commerce_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_e_commerce_skills-2" name="user_e_commerce_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_use_movile_devices_skills-1" name="user_use_movile_devices_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_use_movile_devices_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_use_movile_devices_skills-2" name="user_use_movile_devices_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_technical_support_computers_devices_skills-1" name="user_technical_support_computers_devices_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_technical_support_computers_devices_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_technical_support_computers_devices_skills-2" name="user_technical_support_computers_devices_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_technical_support_movile_devices_skills-1" name="user_technical_support_movile_devices_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_technical_support_movile_devices_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_technical_support_movile_devices_skills-2" name="user_technical_support_movile_devices_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_network_technical_support_skills-1" name="user_network_technical_support_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_network_technical_support_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_network_technical_support_skills-2" name="user_network_technical_support_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_social_media_management_skills-1" name="user_social_media_management_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_social_media_management_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_social_media_management_skills-2" name="user_social_media_management_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_social_media_security_skills-1" name="user_social_media_security_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_social_media_security_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_social_media_security_skills-2" name="user_social_media_security_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_imagen_design_skills-1" name="user_imagen_design_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_imagen_design_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_imagen_design_skills-2" name="user_imagen_design_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_mobile_video_editing_skills-1" name="user_mobile_video_editing_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_mobile_video_editing_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_mobile_video_editing_skills-2" name="user_mobile_video_editing_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_remote_communication_skills-1" name="user_remote_communication_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_remote_communication_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_remote_communication_skills-2" name="user_remote_communication_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_libre_office_applications_skills-1" name="user_libre_office_applications_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_libre_office_applications_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_libre_office_applications_skills-2" name="user_libre_office_applications_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_meme_creations_skills-1" name="user_meme_creations_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_meme_creations_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_meme_creations_skills-2" name="user_meme_creations_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_presentations_creations_skills-1" name="user_presentations_creations_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_presentations_creations_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_presentations_creations_skills-2" name="user_presentations_creations_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_accounting_books_skills-1" name="user_accounting_books_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_accounting_books_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_accounting_books_skills-2" name="user_accounting_books_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_budget_cration_skills-1" name="user_budget_cration_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_budget_cration_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_budget_cration_skills-2" name="user_budget_cration_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_strategic_planning_skills-1" name="user_strategic_planning_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_strategic_planning_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_strategic_planning_skills-2" name="user_strategic_planning_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_project_elaboration_skills-1" name="user_project_elaboration_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_project_elaboration_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_project_elaboration_skills-2" name="user_project_elaboration_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_collective_diagnosis_skills-1" name="user_collective_diagnosis_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_collective_diagnosis_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_collective_diagnosis_skills-2" name="user_collective_diagnosis_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_situational_analysis_tecniques_skills-1" name="user_situational_analysis_tecniques_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_situational_analysis_tecniques_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_situational_analysis_tecniques_skills-2" name="user_situational_analysis_tecniques_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_systematization_community_experiences_skills-1" name="user_systematization_community_experiences_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_systematization_community_experiences_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_systematization_community_experiences_skills-2" name="user_systematization_community_experiences_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_content_assertive_organizational_communication_skills-1" name="user_content_assertive_organizational_communication_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_content_assertive_organizational_communication_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_content_assertive_organizational_communication_skills-2" name="user_content_assertive_organizational_communication_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_robotics_skills-1" name="user_robotics_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_robotics_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_robotics_skills-2" name="user_robotics_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_artificial_intelligence_skills-1" name="user_artificial_intelligence_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_artificial_intelligence_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_artificial_intelligence_skills-2" name="user_artificial_intelligence_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_programming_skills-1" name="user_programming_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_programming_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_programming_skills-2" name="user_programming_skills" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_application_creation_skills-1" name="user_application_creation_skills" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_application_creation_skills-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_application_creation_skills-2" name="user_application_creation_skills" value="NO" class="custom-control-input">
                                ...
                                <div class="card text border-primary mb-3">
                                    <div class="card-body">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <div class="custom-control custom-checkbox mb-3">
                                                <input type="checkbox" class="custom-control-input" name="user_training_needs[]" value="Ciencias del agro" id="user_training_needs-12" onchange="formacion('add_capabilities', this)">
                                                <label class="custom-control-label" for="user_training_needs-12">Stop motion</label>
                                            </div>
                                            <div class="custom-control custom-checkbox mb-3">
                                                <input type="checkbox" class="custom-control-input" name="user_training_needs[]" value="Ciencias del agro" id="user_training_needs-13" onchange="formacion('add_capabilities', this)">
                                        ...
                                        <div class="form-group floating-label floating-label">
                                            ...
                                            <br>
                                            <textarea data="field" name="user_other_training_needs" value="" class="form-control" id="user_other_training_needs" rows="2"></textarea>
                                        </div>
                            ...
                            <div class="col">
                                <div class="card text border-primary mb-3">
                                    <div class="card-body">
                                        ...
                                        <!-- <span class="material-icons text-primary mt-2 mr-4" style="font-size: 32px;">palette</span> -->
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_know_PNCT_MincCYT-1" name="user_know_PNCT_MincCYT" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_know_PNCT_MincCYT-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_know_PNCT_MincCYT-2" name="user_know_PNCT_MincCYT" value="NO" class="custom-control-input">
                                        ...
                                        <!-- <span class="material-icons text-primary mt-2 mr-4" style="font-size: 32px;">palette</span> -->
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_know_PNI_infocentro-1" name="user_know_PNI_infocentro" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="user_know_PNI_infocentro-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="user_know_PNI_infocentro-2" name="user_know_PNI_infocentro" value="NO" class="custom-control-input">
                            ...
                            <div class="col">
                                <div class="card text border-primary mb-3">
                                    <div class="card-body">
                                        ...
                                        <!-- <span class="material-icons text-primary mt-2 mr-4" style="font-size: 32px;">palette</span> -->
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required onchange="tendencias('#formdiv', '#divtext-1', this)" type="radio" id="knowledge_remote_learning-1" name="knowledge_remote_learning-radio" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="knowledge_remote_learning-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required onchange="tendencias('#formdiv', '#divtext-1', this)" type="radio" id="knowledge_remote_learning-2" name="knowledge_remote_learning-radio" value="NO" class="custom-control-input">
                                        ...
                                        <div id="formdiv" style="display: none" class="form-group floating-label floating-label">
                                            <small id="exampleFloatingLabel6Help" class="form-text">
                                                Mencione las modalidades remota
                                            </small>
                                            <br>
                                            <textarea required data="field" name="knowledge_remote_learning" value="" class="form-control" id="divtext-1" rows="2"></textarea>
                                        </div>
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="participation_virtual_training-1" name="participation_virtual_training" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="participation_virtual_training-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="participation_virtual_training-2" name="participation_virtual_training" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required onchange="tendencias('#formdiv-2', '#divtext-2', this)" type="radio" id="experience_online_training-1" name="experience_online_training-radio" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="experience_online_training-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required onchange="tendencias('#formdiv-2', '#divtext-2', this)" type="radio" id="experience_online_training-2" name="experience_online_training-radio" value="NO" class="custom-control-input">
                                        ...
                                        <div id="formdiv-2" style="display: none" class="form-group floating-label floating-label">
                                            <small id="exampleFloatingLabel6Help" class="form-text">
                                                Mencione cuales
                                            </small>
                                            <br>
                                            <textarea required data="field" name="experience_online_training" value="" class="form-control" id="divtext-2" rows="2"></textarea>
                                        </div>
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required onchange="tendencias('#formdiv-3', '#divtext-3', this)" type="radio" id="know_platform_aprendiendo_juntos-1" name="know_platform_aprendiendo_juntos" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="know_platform_aprendiendo_juntos-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required onchange="tendencias('#formdiv-3', '#divtext-3', this)" type="radio" id="know_platform_aprendiendo_juntos-2" name="know_platform_aprendiendo_juntos" value="NO" class="custom-control-input">
                                        ...
                                        <div id="formdiv-3" style="display: none" class="form-group floating-label floating-label">
                                            <small id="exampleFloatingLabel6Help" class="form-text">
                                                Menciona los Talleres en que has participado en la plataforma de Aprendiendo Juntos
                                            </small>
                                            <br>
                                            <textarea required data="field" name="training_received_aprendiendo_juntos" value="" class="form-control" id="divtext-3" rows="2"></textarea>
                                        </div>
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="interest_to_training_on_aprendiendo_juntos-1" name="interest_to_training_on_aprendiendo_juntos" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="interest_to_training_on_aprendiendo_juntos-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required type="radio" id="interest_to_training_on_aprendiendo_juntos-2" name="interest_to_training_on_aprendiendo_juntos" value="NO" class="custom-control-input">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required onchange="tendencias('#formdiv-4', '#divtext-4', this)" type="radio" id="know_benefits_online_training-1" name="know_benefits_online_training-radio" value="SI" class="custom-control-input">
                                            <label class="custom-control-label" for="know_benefits_online_training-1">SI</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input required onchange="tendencias('#formdiv-4', '#divtext-4', this)" type="radio" id="know_benefits_online_training-2" name="know_benefits_online_training-radio" value="NO" class="custom-control-input">
                                        ...
                                        <div id="formdiv-4" style="display: none" class="form-group floating-label floating-label">
                                            <small id="exampleFloatingLabel6Help" class="form-text">
                                                Menciona algunas bondades
                                            </small>
                                            <br>
                                            <textarea required data="field" name="know_benefits_online_training" value="" class="form-control" id="divtext-4" rows="2"></textarea>
                                        </div>
                                        ...
                                        <div class="form-group floating-label floating-label">
                                            ...
                                            <br>
                                            <textarea required data="field" name="suggestions_provided" value="" class="form-control" id="suggestions_provided" rows="2"></textarea>
                                        </div>
            ...
            $.post("core/app/view/getResponsible-view.php", {
                ...
                if (array["nombre"] === "El responsable no está en ese infocentro") {
                    if (getOS() === "Android") {
                        ...
                        toastify('El responsable no está en ese infocentro o no es Facilitador', true, 15000, "error");
                    }
        ...
        if (responsable_tipo === "Coordinador" || responsable_tipo === "Jefe de Estado") {
            $.post("core/app/view/getResponsible_coord-view.php", {
                ...
                if (array["nombre"] === "El Coordinador no está registrado") {
                    alert("El coordinador no está resgistrado en Gestión Humana");
                    document.getElementById("user_dni").focus();
                    document.getElementById("user_dni").value = "";
                    return;
                }
