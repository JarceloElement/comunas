...
if (isset($action_lines) && $action_lines != null) {
    ...
    foreach ($action_lines as $row) {
        ...
        array_push($pie_chart_labels, "'" . $row['line_name'] . "'");
...
<script>
    $(document).ready(function () {
        ...
        $(function () {
            $('#table-report-line-action').DataTable({
        ...
        $(function () {
            $('#datepicker-reports-line-action').daterangepicker({
                "showDropdowns": true,
                ranges: {
                    'Hoy': [moment(), moment()],
            ...
            $('#datepicker-reports-line-action').on("change", function (ev, picker) {

                var start_date = ev.target.value.split(" - ")[0].replaceAll("/", "-");
                var end_date = ev.target.value.split(" - ")[1].replaceAll("/", "-");

                document.getElementById("spinner").style.display = "inline-block";
                document.getElementById("table-report-line-action").style.display = "none";

                $.post({

                    url: "index.php?action=ajax&function=reports_by_action_line",
                    dataType: 'json',
                    data: {
                    ...
                    success: (response, data) => {
                        ...
                        let table = $('#table-report-line-action').DataTable();
                        table.clear();
                        ...
                        document.getElementById("table-report-line-action").style.display = "table";
                    }
                });
            });
        });
        ...
        var action_line_colors = [];
        for (var counter1 = 0; counter1 < <?php echo $action_lines->num_rows ?>; counter1++) {
            action_line_colors.push(ColorCode());
        }
        ...
        let myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: action_line_colors,
                }]
            },
            ...
            options: {
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: 'Lineas de accion en general',
                        padding: 0,
                        // color: '#56b2c4',
                    }
        ...
        $(function () {
            ...
            $('#datepicker').on("change", function (ev, picker) {
                ...
                $.post({
                    url: "index.php?action=ajax&function=reports_by_action_line_in_general",
                    dataType: 'json',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
    ...
    <div aria-labelledby="estates-tab" class="tab-pane fade show active" id="estates" role="tabpanel">
        <div class="content">
            <div class="container">
                ...
                <h4 class="text-center mb-4 mt-2">Lineas de accion</h4>
                <div class="form-group">
                    <label for="fecha" class="control-label"><i class="fa fa-calendar"></i> Fecha de la
                        actividad</label>
                    <input type="text" name="fecha" required class="form-control" id="datepicker-reports-line-action"
                        placeholder="Fecha">
                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <table class="table" id="table-report-line-action">

                                        <thead>
                                            <tr>
                                                <th scope="col">Estado</th>
                                                <?php foreach ($action_lines as $row) { ?>
                                                    <th scope="col"><?= $row['line_name'] ?></th>
                                                <?php } ?>
    ...
    <div aria-labelledby="national-tab" class="tab-pane fade" id="national" role="tabpanel">
        <div class="offset-md-1 col-md-10">
            <div class="card text-center">
                <div class="card-body">
                    <h5 class="card-title">Lineas de accion en general</h5>
                    <div class="text-center">
                        <div class="col-md-12 ">
                            <div class="form-group">
                                <label for="fecha" class="control-label"><i class="fa fa-calendar"></i> Fecha de la
