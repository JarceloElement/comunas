          ...
          <td>38.36.7.199</td>
				...
				<?php
					...
					foreach($res as $row){
						...
						<td><?php echo date("d/m/Y", strtotime($row["f_instalacion"])); ?></td>
						<td><?php echo $row["estado"]; ?></td>
						<td><?php echo $row["municipio"]; ?></td>
						<td><?php echo $row["tecno_internet"]; ?></td>
						<td><?php echo $row["estatus"]; ?></td>
						<td><?php echo $row["motivo_cierre"]; ?></td>
						<td><?php echo $row["estatus_op"]; ?></td>
						<td><?php echo $row["transferido"]; ?></td>
						<td><?php echo $row["espacio_inst"]; ?></td>
						<td><?php echo $row["tipo_zona"]; ?></td>
						<td><?php echo $row["municipio_fronterizo"]; ?></td>
